<header>
    ...
    <div class="first">
        <a class="logo" href="/projetofolheto/adm.folheto/index.php"><img src="/projetofolheto/folheto/images/folheto.png" alt="Folheto logo"><div class="text">Folheto</div></a>
    </div>
    ...
    <div class="second">
        ...
        <a class="sign-in" href="/projetofolheto/adm.folheto/actions/signout.php">
            <img src="/projetofolheto/adm.folheto/images/person.svg" alt="Expandir opções de perfil">
            Conta
            <img src="/projetofolheto/adm.folheto/images/expand_more.svg" alt="Expandir opções de perfil">
        </a>
    </div>
