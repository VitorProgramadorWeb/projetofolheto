<div class="menu-wrapper" onclick="closeMenu();">
    <nav onclick="event.stopPropagation();">
        <button class="button close-button" type="button" onclick="closeMenu();"><img src="/projetofolheto/adm.folheto/images/close.svg" alt="Mostrar menu"></button>
        <ul class="menu">
            <li><a class="sign-up" href="/projetofolheto/adm.folheto/signup.php">Cadastrar-se</a></li>
            <li><a class="sign-in" href="/projetofolheto/adm.folheto/signin.php">Entrar</a></li>
            <hr>
            <li><a href="/projetofolheto/adm.folheto/index.php">Produtos</a></li>
            <li><a href="/projetofolheto/adm.folheto/list.php">Lista</a></li>
            <hr>
